...
import pickle
from model.helper import pseudo_cate
...
for i in range(n_run):
    ...
    cate_test.append(torch.Tensor(RF(t_a, x_a, y_a, x_t)))
    ...
    for j_ind, j in enumerate(n_unc_size):
        ...
        best_params_tn['lambd_delta'] = np.sqrt((1/d_hidden)*np.log(d_hidden)/j)
        ...
        #Train head regulaized on uncofounded data (Step 2)
        best_params_mtl['lambd_delta'] = np.sqrt((1/n_hidden)*np.log(d_hidden)/j)
        ...
        #Train head regulaized on uncofounded data (Step 2)
        best_params_mtl_bal['lambd_delta'] = np.sqrt((1/d_hidden)*np.log(d_hidden)/j)
...
# folder = 'Experiments/Real_World/n_unc/'+ setting +'/'
# 
# cate_trans_reg_l = np.load(folder+'exp_'+setting+'_trans_reg_l.npy')
# cate_trans_l = np.load(folder+'exp_'+setting+'_trans_l.npy')
# cate_conf_l = np.load(folder+'exp_'+setting+'_conf_l.npy')
# cate_mtl_l = np.load(folder+'exp_'+setting+'_mtl_l.npy')
# cate_mtl_delta_1_l = np.load(folder+'exp_'+setting+'_mtl_delta_1_l.npy')
# cate_mtl_bal_l = np.load(folder+'exp_'+setting+'_mtl_bal_l.npy')
# cate_mtl_bal_delta_1_l = np.load(folder+'exp_'+setting+'_mtl_bal_delta_1_l.npy')
# cate_trans_delta_1_l = np.load(folder+'exp_'+setting+'_trans_delta_1_l.npy')
# cate_trans_delta_2_l = np.load(folder+'exp_'+setting+'_trans_delta_2_l.npy')
# cate_trans_out_l = np.load(folder+'exp_'+setting+'_trans_out_l.npy')
# cate_trans_out_1_l = np.load(folder+'exp_'+setting+'_trans_out_1_l.npy')
# cate_trans_out_2_l = np.load(folder+'exp_'+setting+'_trans_out_2_l.npy')
# cate_trans_bal_l = np.load(folder+'exp_'+setting+'_trans_bal_l.npy')
# cate_trans_bal_out_1_l = np.load(folder+'exp_'+setting+'_trans_bal_out_1_l.npy')
# cate_trans_bal_out_2_l = np.load(folder+'exp_'+setting+'_trans_bal_out_2_l.npy')
# cate_unc_l = np.load(folder+'exp_'+setting+'_unc_l.npy') 
# cate_avg_l = np.load(folder+'exp_'+setting+'_avg_l.npy') 
# cate_weight_l = np.load(folder+'exp_'+setting+'_weight_l.npy') 
